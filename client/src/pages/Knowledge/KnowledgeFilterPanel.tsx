...
const SUBJECT_VERSION_MAP: Record<string, Record<string, string>> = {
  ...
  '上海市': { '数学': '沪教版', '语文': '部编版', '英语': '沪教牛津版', '物理': '沪教版', '化学': '沪教版', '生物': '沪教版', '历史': '部编版', '地理': '沪教版', '政治': '部编版' },
  '江苏省': { '数学': '苏教版', '语文': '部编版', '英语': '译林版', '物理': '苏科版', '化学': '沪教版', '生物': '苏教版', '历史': '部编版', '地理': '人教版', '政治': '部编版' },
  '浙江省': { '数学': '浙教版', '语文': '部编版', '英语': '人教版', '物理': '浙教版', '化学': '浙教版', '生物': '浙教版', '历史': '部编版', '地理': '湘教版', '政治': '部编版' },
...
function getVersionForProvinceSubject(province: string, subject: string): string {
  const provinceMap = SUBJECT_VERSION_MAP[province];
