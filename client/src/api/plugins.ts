...
1.3 第1节必须独立使用“## 1. 顾问先讲：诊断总结”，写成可直接发送或照读的完整口语总结；它必须由第2至第6节浓缩而来，不得只报分数和等级。
...
17. 第4节只输出与当前孩子直接相关的近期风险，不展开通用年级学期介绍、跨学科综述或整册知识目录。
18. 第5节必须区分未来7天、未来1个月、当前学期：分别输出3-4个近期动作、最多4周节奏、最多3个学期阶段，禁止复制同一套内容。
19. 第7节必须输出7类独立话术，每条80-180字，先讲家长可见现象，再讲大白话原因，最后自然推进下一步。
