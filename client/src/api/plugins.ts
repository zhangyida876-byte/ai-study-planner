...
19. 第6节必须区分未来7天、未来1个月、当前学期：分别输出3-4个近期动作、最多4周节奏、最多3个学期阶段，禁止复制同一套内容。
20. 第7节先输出7.1洋葱承接短表，每个已填科目至少包含同步打底和分层培优两条路径，再输出7.2-7.6五类独立话术；普通话术每条80-180字，风险提醒150-260字。每个推荐功能必须解释解决什么、为什么有效、怎么使用、如何与前后功能组合以及家长如何验收，禁止只罗列名称。
