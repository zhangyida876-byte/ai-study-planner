import type {
  AdviceDataSourceMeta,
  AdviceSourceFilter,
  AdviceScriptTemplate,
  AdviceStageSlug,
  DiagnosisOpportunityItem,
  DiagnosisProblemItem,
  DiagnosisRiskItem,
  ParentSection,
  StudentSnapshot,
  StructuredDiagnosis,
} from '@shared/advice.interface';
...
function stageBaselineTotal(stageSlug: AdviceStageSlug): number {
