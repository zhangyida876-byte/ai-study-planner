...
const OBJECTION_HANDLING_SCRIPTS: ObjectionHandlingScript[] = [
  ...
  },
  {
    ...
    source: '小学四部培训：异议处理',
    sourceUrl: 'https://guanghe.feishu.cn/docx/doxcnrnsrjC2R64dozGViJj3rHf',
    keywords: ['太贵', '价格贵', '学费高', '预算不够', '没钱', '初高联报太贵', '你们怎么这么贵', '价格变化', '等优惠', '优惠结束', '申请之前优惠', '活动结束能不能优惠', '知道价格后再看看'],
    content:
  ...
  },
  {
    ...
    source: '代表性异议处理文档--白小峰',
    sourceUrl: 'https://guanghe.feishu.cn/wiki/FQWdwjRQOiNn6lklRpgcNOIun5b',
    keywords: ['便宜点', '再优惠', '少一点', '最后优惠', '砍价', '优惠点我就买', '能不能便宜点', '价格能不能再优惠', '优惠券', '活动价'],
    content:
  ...
  },
  {
    ...
    keywords: ['不要平板', '有平板了', '平板能退吗', '不要赠品', '赠品', '平板抵扣', '平板只能抵扣900', '不想让孩子看平板', '视力不好', '没节制', '平板名额', '平板发货'],
    content:
  ...
  },
  {
    ...
    sourceUrl: 'https://guanghe.feishu.cn/docx/Csn4d6brBo1nS6xoTdjcm8wznQe',
    intentGroup: 'defer',
    keywords: ['孩子先看看后面有需要再说', '先看看', '后面有需要再说', '有需要再说', '以后再说', '等开学再说', '现在不着急', '再考虑一下', '先试试', '先体验', '孩子要考虑', '自己无法决定', '跟爸爸商量', '跟妈妈商量', '跟老公商量', '问老公', '爸爸不同意', '妈妈不同意', '父母不同意', '家里不同意', '孩子先跟父母商量', '不需要', '先不需要', '有自己的规划', '老师说看看就行', '不需要开会员', '免费课就可以', '学免费的', '没有报课需求'],
    content:
